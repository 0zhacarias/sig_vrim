...
<!--             <template >
            ...
            <template>
                ...
                <v-row justify="space-around" class="py-10">
                    ...
                    <v-btn :disabled="imoveis.estado_imoveis_id!==3" class="ml-auto" color="#4527A0" dense outlined @click="marcarVisita()"> {{ imoveis.estado_imoveis_id==3 ? 'Marcação de visita' : 'Pedido de marcação feito' }} </v-btn>
