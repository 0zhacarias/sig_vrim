<template>
    <PortalLayout>
        <!-- <div class="heroBlock" name="carrousel">
        ...
        <v-row elevation="2" >
                <v-col>
                    <v-autocomplete clearable rounded auto-select-first dense class="borda-white">
                    </v-autocomplete>
                </v-col>
                <v-col>
                    <v-autocomplete clearable rounded auto-select-first  dense class="borda-white">
            ...
            <v-toolbar-title class="deep-purple darken-3 elevation-0" :style="'border-radius: 0px 0px 0px 300px'">
                ...
                <v-row class="p-0">
                    ...
                    <v-col cols="12" sm="7" md="9">
                        <v-card-text class="white--text" :style="'justify-content: center; padding-top:6rem'">
                            ...
                            <v-row class="px-5">
                                ...
                                <v-col md="2">
                                    <v-btn :disabled="loading" class="ma-1" x-large>
                                        pesquisar
                                    </v-btn>
                                </v-col>
                            </v-row>
