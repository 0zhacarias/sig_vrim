...
Route::post('/nao-validar-processo', [App\Http\Controllers\ActividadeImoveisController::class, 'gostar_imovel'])->name('gostar');
Route::post('/gostar-imovel', [App\Http\Controllers\ActividadeImoveisController::class, 'nao_gostar_imovel'])->name('naogostar');
Route::post('/validar-processo', [App\Http\Controllers\ActividadeImoveisController::class, 'validar_processo'])->name('home');
Route::post('/nao-gostar-imovel', [App\Http\Controllers\ActividadeImoveisController::class, 'nao_validar_processo'])->name('home');
