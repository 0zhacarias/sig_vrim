...
-- A despejar dados para tabela bd_sigim.actividade_imoveis: ~9 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `imoveis` (
  ...
  `codigo_imovel` varchar(255) COLLATE latin1_bin DEFAULT NULL,
...
-- A despejar dados para tabela bd_sigim.imoveis: ~20 rows (aproximadamente)
DELETE FROM `imoveis`;
INSERT INTO `imoveis` (`id`, `designacao`, `codigo_imovel`, `descricao`, `cozinha`, `mobiliado_id`, `suite`, `sala_de_estar`, `numero_banheiro`, `metros`, `preco`, `tempo_arrendar`, `lote`, `operacao_imoveis_id`, `estado_imoveis_id`, `tipologia_imoveis_id`, `categoria_imoveis_id`, `cadastrado_por`, `publicado_por`, `tipo_documentacoes_id`, `condicao_imoveis_id`, `tanqueagua`, `regeitado_por`, `created_at`, `updated_at`, `deleted_at`, `localizacao`, `imposto_predial`, `ginasio`, `gerador`, `piscina`, `churrasqueira`, `maquina_lavar_roupa`, `numero_garagem`, `mesa_cadeira`, `arcondicionados`, `armario_embutido`, `mobiliado`, `provincia_id`, `foto_principal`) VALUES
	...
	(77, 'APARTAMENTO T3 NO PROJETO NOVA VIDA\n', NULL, 'APARTAMENTO T3 NO PROJETO NOVA VIDA\n', 1, NULL, 4, NULL, 1, 4555, 400000, NULL, NULL, NULL, 4, NULL, NULL, 404, NULL, NULL, 1, 1, NULL, '2023-09-08 20:24:28', '2023-09-27 19:12:23', NULL, 'Luanda Luanda', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 1, '', 9, 'Foto_principal/1XhD8JFGT2rNcw23UeKl1eLCkjf6Oc710HnS6e7G.jpg'),
	(78, 'APARTAMENTO T4  Huambo', NULL, 'APARTAMENTO T4 NO PROJETO NOVA VIDA\n', 0, NULL, 1, NULL, 0, 455, 400000, NULL, NULL, NULL, 4, NULL, NULL, 407, NULL, NULL, 3, 0, NULL, '2023-09-08 20:26:39', '2023-09-27 19:25:36', NULL, 'Luanda Viana', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, '', 1, 'Foto_principal/TpMe3jIpx9dBhU3yhJTFN563z9Bo7ZafLS9GoI3E.jpg'),
	...
	(94, '1www', NULL, '1www', 1, NULL, 1, NULL, 1, 22, NULL, NULL, NULL, NULL, 3, 1, 1, 406, NULL, NULL, 1, NULL, NULL, '2023-09-11 20:43:10', '2023-09-11 20:43:10', NULL, 'dddd', NULL, 1, NULL, NULL, 1, 1, 1, 1, 1, 1, 'TRUE', 1, 'Foto_principal/iEOeCjrrnoC40t2LSzjkVROrij15Yuc1EM0A8kXZ.jpg'),
	(97, 'sss', NULL, 'sss', 1, NULL, 1, NULL, 1, 300, NULL, NULL, NULL, NULL, 3, 1, 1, 406, NULL, NULL, 1, NULL, NULL, '2023-09-11 20:47:46', '2023-09-11 20:47:46', NULL, '333 ddd', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 'TRUE', 6, 'Foto_principal/lw5tFn0yVFj6viI9hNkLfQFG7JBRnXSx4K7focVF.jpg'),
...
CREATE TABLE IF NOT EXISTS `pessoas` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `zona_trabalho` varchar(250) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- A despejar dados para tabela bd_sigim.pessoas: ~1 rows (aproximadamente)
DELETE FROM `pessoas`;
INSERT INTO `pessoas` (`id`, `nome`, `sobre_nome`, `data_nascimento`, `numero_telefone`, `numero_identificacao`, `email`, `foto`, `estado_civis_id`, `genero_id`, `user_id`, `tipo_documentacoes_id`, `created_at`, `updated_at`, `deleted_at`, `zona_trabalho`) VALUES
	(2, 'Pambaleiro A', 'Pambaleiro A', NULL, NULL, NULL, 'pambaleiroA@gmail.com', NULL, NULL, NULL, 410, NULL, '2023-09-18 19:27:27', '2023-09-18 19:27:27', NULL, 'BO'),
	(4, 'Mateus Abel', 'Mateus Abel', NULL, '998443965', NULL, NULL, NULL, NULL, NULL, 418, NULL, '2023-09-19 20:57:15', '2023-09-19 20:57:15', NULL, NULL),
	(5, 'Zhacarias Zhacarias', 'Zhacarias Zhacarias', NULL, NULL, NULL, 'ga@gmail.com', NULL, NULL, NULL, 419, NULL, '2023-09-27 17:27:01', '2023-09-27 17:27:01', NULL, NULL);
...
-- A despejar dados para tabela bd_sigim.solicitar_visitas: ~8 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=420 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- A despejar dados para tabela bd_sigim.users: ~7 rows (aproximadamente)
DELETE FROM `users`;
INSERT INTO `users` (`id`, `name`, `lastName`, `telefone`, `email`, `username`, `email_verified_at`, `password`, `tipo_user_id`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `avatar`) VALUES
	...
	(419, 'Zhacarias Zhacarias', NULL, NULL, 'ga@gmail.com', NULL, '2023-09-27 19:27:01', '$2y$10$uIBwU8D9cT1fxgR1rYuire./tUaBY0CryRzuvKLOcrdC6a7lxU0X.', 2, NULL, '2023-09-27 17:27:01', '2023-09-27 17:27:01', NULL, NULL);
