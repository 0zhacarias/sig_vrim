...
-- A despejar dados para tabela bd_sigim.estado_civis: ~1 rows (aproximadamente)
...
-- A despejar dados para tabela bd_sigim.fotos_imoveis: ~119 rows (aproximadamente)
...
-- A despejar dados para tabela bd_sigim.pessoas: ~3 rows (aproximadamente)
DELETE FROM `pessoas`;
...
-- A despejar dados para tabela bd_sigim.solicitar_visitas: ~7 rows (aproximadamente)
...
-- A despejar dados para tabela bd_sigim.users: ~8 rows (aproximadamente)
DELETE FROM `users`;
